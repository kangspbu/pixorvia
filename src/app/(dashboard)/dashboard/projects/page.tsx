...
import { getUserProjects } from "@/action/projectActions";
...
export default function ProjectsPage() {
  ...
  // Filter and sort projects with debounced search
  useEffect(() => {
  ...
  }, [userProjects, debouncedSearchQuery, sortBy]);
